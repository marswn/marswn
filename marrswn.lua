...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./marrswn.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BS", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S marrswn -X kill
screen -S marrswn ./marrswn
done
]])  
file:close() 
...
local marrswn_Msg = ''  
if msgs < 100 then 
marrswn_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
marrswn_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
marrswn_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
marrswn_Msg = 'متفاعل' 
elseif msgs < 1200 then 
marrswn_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
marrswn_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
marrswn_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
marrswn_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
marrswn_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
marrswn_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
marrswn_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
marrswn_Msg = 'امبروطور التفاعل☣️' 
elseif msgs < 10000000000 then 
marrswn_Msg = 'رب التفاعل💖'  
end 
return marrswn_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcemarrswn(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,marrswn_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf marrswn.lua')
os.execute('wget https://raw.githubusercontent.com/marrswn/marrswn/master/marrswn.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..marrswnk..''..marrswn..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤¦ العضو » ['..result.title_..'](t.me/'..(username or 'DEVmarrswn')..')'
...
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVmarrswn')..')'
status  = '\n📫¦ تم ترقيته مطور في البوت'
...
local marrswn_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if marrswn_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..marrswn_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/DEVmarrswn)}\n📛¦["..marrswn_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/DEVmarrswn)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVmarrswn')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVmarrswn')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
local UserName = (b.username_ or "marrswn")
...
usertext = '\n👤¦ المستخدم » ['..result.title_..'](t.me/'..(username or 'DEVmarrswn')..')'
statusk  = '\n📫¦ تم طرده من هنا'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
 usertext = '\n👤¦ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVmarrswn')..')'
 statusk  = '\n📫¦ تم طرده من هنا'
send(msg.chat_id_, msg.id_, usertext..statusk)
else
 usertext = '\n👤¦ المستخدم » '..userid..''
...
time = times * 60
local function Restricted(Kara,marrswn)
if tonumber(marrswn.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(marrswn.sender_user_id_,msg.chat_id_)..' )')
return false  
end
if Can_or_NotCan(marrswn.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(marrswn.sender_user_id_,msg.chat_id_)..' )')
else
MuteUser(msg.chat_id_,marrswn.sender_user_id_,msg.date_+time)
local function name(kara,marrswn)
if marrswn.username_ == '' then name = marrswn.first_name_ else name = marrswn.username_ end
send(msg.chat_id_,msg.id_,"⚠ ¦ العضو《["..name.."](tg://user?id="..marrswn.sender_user_id_..")》\nا┄─━━◉━━─┄\n⏳¦ تم كتم لمدة "..times.." دقايق ⏰")
end
getUser(marrswn.sender_user_id_,name)
end
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else
...
t = "\n📌¦ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local marrswn_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..marrswn_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز 🕵🏻‍♀️' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVmarrswn')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..marrswn_Msg[math.random(#marrswn_Msg)]..']') 
return false
end
...
marrswn = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(marrswn)
...
--------------------------------------------------------------------------------------------------------------
Sourcemarrswn(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local marrswn = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if marrswn then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..marrswn.."] \n") 
