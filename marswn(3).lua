...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./marswn.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BS", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S marswn -X kill
screen -S marswn ./marswn
done
]])  
file:close() 
...
local marswn_Msg = ''  
if msgs < 100 then 
marswn_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
marswn_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
marswn_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
marswn_Msg = 'متفاعل' 
elseif msgs < 1200 then 
marswn_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
marswn_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
marswn_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
marswn_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
marswn_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
marswn_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
marswn_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
marswn_Msg = 'امبروطور التفاعل☣️' 
elseif msgs < 10000000000 then 
marswn_Msg = 'رب التفاعل💖'  
end 
return marswn_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcemarswn(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,marswn_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf marswn.lua')
os.execute('wget https://raw.githubusercontent.com/marswnBOT/marswn/master/marswn.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..marswnk..''..marswn..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤¦ العضو » ['..result.sender_user_id_..'](t.me/'..(data.username_ or 'DEVmarswn')..')' 
...
local marswn_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if marswn_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..marswn_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/DEVmarswn)}\n📛¦["..marswn_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/DEVmarswn)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVmarswn')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVmarswn')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
local UserName = (b.username_ or "marswn")
...
usertext = '\n👤¦ المستخدم » ['..result.sender_user_id_..'](t.me/'..(data.username_ or 'DEVmarswn')..')' 
statusk  = '\n📫¦ تم طرده من هنا'
...
time = times * 60
local function Restricted(Kara,marswn)
if tonumber(marswn.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(marswn.sender_user_id_,msg.chat_id_)..' )')
return false  
end
if Can_or_NotCan(marswn.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(marswn.sender_user_id_,msg.chat_id_)..' )')
else
MuteUser(msg.chat_id_,marswn.sender_user_id_,msg.date_+time)
local function name(kara,marswn)
if marswn.username_ == '' then name = marswn.first_name_ else name = marswn.username_ end
send(msg.chat_id_,msg.id_,"⚠ ¦ العضو《["..name.."](tg://user?id="..marswn.sender_user_id_..")》\nا┄─━━◉━━─┄\n⏳¦ تم كتم لمدة "..times.." دقايق ⏰")
end
getUser(marswn.sender_user_id_,name)
end
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else
...
usertext = '\n👤¦لعضو » ['..result.sender_user_id_..'](t.me/'..(data.username_ or 'DEVmarswn')..')' 
status  = '\n📥¦ تم الغاء حظره من هنا'
send(msg.chat_id_, msg.id_, usertext..status)
end;end,nil)
return false
...
t = "\n📌¦ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local marswn_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..marswn_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز 🕵🏻‍♀️' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVmarswn')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..marswn_Msg[math.random(#marswn_Msg)]..']') 
return false
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الاصدقاء')
...
marswn = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(marswn)
...
--------------------------------------------------------------------------------------------------------------
Sourcemarswn(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local marswnbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if marswnbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..marswnbot.."] \n") 
